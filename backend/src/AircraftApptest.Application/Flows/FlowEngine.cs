                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = Type.GetType("AircraftApptest.Approvals.IApprovalAppService, AircraftApptest.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in AircraftApptest.Application assembly");
                            ...
                            var submitInputType = Type.GetType("AircraftApptest.Approvals.Dto.SubmitApprovalInput, AircraftApptest.Application")!;
