...
{
    public class AircraftApptestCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = string.IsNullOrEmpty(envConnStr)
                ? AircraftApptestConsts.ConnectionStringName
                : envConnStr;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AircraftApptestCoreModule).GetAssembly());
        }
    }
}
