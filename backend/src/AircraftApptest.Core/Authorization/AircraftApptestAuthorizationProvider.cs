...
namespace AircraftApptest.Authorization
{
    public class AircraftApptestAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, AircraftApptestConsts.LocalizationSourceName);
        }
    }
}
