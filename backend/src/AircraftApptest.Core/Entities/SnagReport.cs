...
namespace AircraftApptest.Entities
{
    ...
    // Initial: Open | Transitions: Open→InProgress[Approve], InProgress→PendingCRS[Approve], InProgress→InProgress[Revise], PendingCRS→Closed[Approve], PendingCRS→InProgress[Revise]
    [Table("SnagReports")]
