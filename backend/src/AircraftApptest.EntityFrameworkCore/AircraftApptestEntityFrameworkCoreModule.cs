...
{
    [DependsOn(typeof(AircraftApptestCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class AircraftApptestEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<AircraftApptestDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AircraftApptestEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
