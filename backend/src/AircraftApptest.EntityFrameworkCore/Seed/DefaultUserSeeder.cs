...
using AircraftApptest.Authorization;
using AircraftApptest.Entities;

namespace AircraftApptest.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "LineMechanic", DisplayName = "Line Mechanic", Description = "Hat bakım teknisyeni — snag raporlarını oluşturur, üzerine atanan raporları inceler ve CRS onayına gönderir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new[] { "SnagReport.Create", "SnagReport.Read", "SnagReport.Update", "SnagReport.ChangeStatus", "Aircraft.Read" };
                ...
                {
                    customRole_1 = new AppRole { Name = "CertifyingStaff", DisplayName = "Certifying Staff", Description = "Sertifikalandırma personeli — snag raporlarını son olarak onaylar, CRS numarasını kaydeder, imzalar ve kapatır; eksik bulursa hat mekaniğine geri gönderir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_1 = new[] { "SnagReport.Read", "SnagReport.Create", "SnagReport.Update", "SnagReport.Delete", "SnagReport.ChangeStatus", "Aircraft.Read" };
