...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'reportedById', header: 'Reported By Id', sortable: true },
  { field: 'detectionDate', header: 'Detection Date', sortable: true, filterType: 'datepicker', html: (row: Record<string, unknown>) => row.detectionDate ? new Date(String(row.detectionDate)).toLocaleDateString() : '—' },
  { field: 'workPerformed', header: 'Work Performed', sortable: true, searchable: true, filterType: 'text' },
  { field: 'crsNumber', header: 'Crs Number', sortable: true, searchable: true, filterType: 'text' },
